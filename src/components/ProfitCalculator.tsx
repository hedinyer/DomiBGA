...
export default function ProfitCalculator() {
    ...
    return (
        <section className="min-h-screen flex items-center justify-center bg-surface py-20 px-6">
                ...
                <div className="w-full md:w-1/2">
                    <div className="glass-dark p-8 rounded-3xl border border-white/10 relative overflow-hidden">
                        <div className="absolute top-0 right-0 p-4 opacity-20">
                            <span className="font-mono text-6xl font-bold text-white">$$$</span>
                        </div>

                        <div className="mb-10">
                            <label className="block text-gray-400 text-sm font-mono mb-4 uppercase">Volumen de Ventas Mensual</label>
                        ...
                        <div className="space-y-6">
                            <div className="flex justify-between items-center border-b border-white/10 pb-4">
                                <span className="text-gray-400">Tarifas Competencia (30%)</span>
                                <span className="text-red-500 font-mono text-xl">-${competitorFee.toLocaleString()}</span>
                            </div>
                            <div className="flex justify-between items-center border-b border-white/10 pb-4">
                                <span className="text-gray-400">Tarifas DomiBGA (5%)</span>
                            ...
                            <div className="mt-8 bg-primary/10 p-6 rounded-xl border border-primary/20">
                                ...
                                <motion.span
                                    ...
                                    className="block text-5xl font-display font-bold text-white text-glow"
                                >
                                    ${(savings * 12).toLocaleString()}
                                </motion.span>
                                <span className="text-gray-400 text-xs mt-2 block">Eso es suficiente para una nueva furgoneta de reparto.</span>
                            </div>
                        </div>
                    </div>
                </div>
